...
```math
HP(s) = \frac{s^2}{s^2+\frac{\omega_0}{Q_0} s+\omega_0^2}; \quad
LP(s) = \frac{\omega_0^2}{s^2+\frac{\omega_0}{Q_0} s+\omega_0^2}; \quad
BP(s) = \frac{\frac{\omega_0}{Q_0} s}{s^2+\frac{\omega_0}{Q_0} s+\omega_0^2}
```
...
```
-->
Фильтры Баттерворта вводятся через соотношения величин $F_c$ - частота среза, $F_s$ - частота дискретизации, $Q$ - добротность фильтра на частоте среза. $K = \tg(\pi F_c/F_s)$ 
