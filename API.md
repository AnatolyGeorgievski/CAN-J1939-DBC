...
Нормативные документы выпущеные в форме рекомендаций и методических рекоментдаций, со временем становятся стандартами. 
...
* [Р 1323565.1.029-2019] Протокол защищенного обмена для индустриальных систем
...
* [Р 1323565.1.046-2023] Защищенный протокол взаимодействия квантово-криптографической аппаратуры выработки и распределения ключей и средства криптографической защиты информации.
...
Национальный комитет определяет `KDF_TREE_CMAC`
$$K(i) = CMAC (K_{IN}, [i]_1 || Label || aL || SN || Node || CS || cL || oL)~.$$

ключевой материал вырабатывается на основе входных параметров: метки ключа (Label), счетчик использования (SN), режим защиты (CS), и различных длинн. Поле Node - идентификатор ключа отправителя сообщения. 
...
Сервис ключей "ProtoQa" обрабатывает запросы всех участников обмена и раздает ключи шифрования, конфигурационные файлы и файлы обновления встроенного ПО. 
